    ...
    await _service
      ...
      if (value['success'] == true) {
        if (_detailsController.accountState.value.watchlist != true) {
          ...
          Get.showSnackbar(
            GetBar(
              message: 'Agregado exitosamente a tu lista de favoritos',
              isDismissible: true,
          ...
          Get.showSnackbar(
            GetBar(
              message: 'Has Quitado de tu lista de favoritas.',
              isDismissible: true,
    ...
    await _service
      ...
      if (value['success'] == true) {
        if (_detailsController.accountState.value.favorite != true) {
          ...
          Get.showSnackbar(
            GetBar(
              message: 'Agregar a mis favoritas.',
              isDismissible: true,
              duration: const Duration(milliseconds: 1600),
              dismissDirection: SnackDismissDirection.HORIZONTAL,
              snackStyle: SnackStyle.GROUNDED,
              ...
              mainButton: TextButton(
                ...
                child: const Text('Ver mis favoritas'),
              ),
            ),
          );
        } else {
          ...
          Get.showSnackbar(
            GetBar(
              message: 'Remover de mis favoritas.',
              isDismissible: true,
              duration: const Duration(milliseconds: 1600),
              dismissDirection: SnackDismissDirection.HORIZONTAL,
              snackStyle: SnackStyle.GROUNDED,
