    ...
    return GetBuilder(
      ...
      builder: (controller) => WidgetBuilderHelper(
        ...
        onErrorBuilder: const Center(
          child: Text('error en la carga de datos ...'),
        ),
          ...
          children: [
            ...
            Padding(
              ...
              child: StoryLineTextBuilder(
                  text: _detailsController.movieDetail.value.overview ??
                      "No puedes hacer nada, no hay acceso a los datos...lo siento"),
            ),
            ...
            GetBuilder(
              ...
              builder: (controller) {
                return WidgetBuilderHelper(
                  ...
                  onErrorBuilder: const Center(
                    child: Text('algo ocurrio en la descarga'),
                  ),
                );
              },
            ),
            ...
            GetBuilder(
              ...
              builder: (controller) => WidgetBuilderHelper(
                ...
                onErrorBuilder: const Center(
                  child: Text('error y no hay nada que hacer ...'),
                ),
              ),
            )
          ],
