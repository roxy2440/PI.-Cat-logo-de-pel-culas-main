    ...
    return WillPopScope(
      onWillPop: () async {
        Get.dialog(AlertDialog(
          title: const Text('Ya te cansasteeeeee? Nos abandonas?'),
          actions: [
            TextButton(
              onPressed: () {
              ...
              child: const Text('Salirme y cerrar bien la session'),
            ),
            TextButton(
              onPressed: () {
                exit(0);
            ...
            child: Obx(
              () => WidgetBuilderHelper(
                ...
                onErrorBuilder: const Center(
                  child: Text(
                      'error, no te culpes, no es tu culpa, error al cargar datos ...'),
                ),
  ...
  Widget guestBottomNavBarBuilder() => SafeArea(
        child: Obx(
          () => WidgetBuilderHelper(
            ...
            onErrorBuilder: const Center(
              child:
                  Text('error, error, error, necesito ir al psicologooooo...'),
            ),
            onSuccessBuilder: BottomNavigationBar(
              ...
              selectedItemColor: Color.fromARGB(255, 243, 58, 33),
              items: List.from(
                guestMenus.map(
        ...
        child: Obx(
          () => WidgetBuilderHelper(
            ...
            onSuccessBuilder: BottomNavigationBar(
              ...
              unselectedFontSize: 0,
              selectedFontSize: 0,
              selectedIconTheme: const IconThemeData(color: Color.fromARGB(255, 243, 40, 33)),
