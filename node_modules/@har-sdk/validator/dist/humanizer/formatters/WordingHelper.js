export class WordingHelper {
    static humanizeComparison(keyword) {
        return keyword.startsWith('min') ? 'more' : 'less';
    }
    static humanizeList(arr, conjunction = 'and') {
        if (arr.length === 0) {
            return 'nothing';
        }
        if (arr.length === 1) {
...
//# sourceMappingURL=WordingHelper.js.map